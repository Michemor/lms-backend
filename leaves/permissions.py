...
class IsAdminRole(BasePermission):
    ...
    def has_permission(self, request, view):
        return request.user.is_authenticated and request.user.role == Employee.Role.ADMIN
...
class IsAdminOrHROfSameInstitutionAndDepartment(BasePermission):
    ...
    def has_object_permission(self, request, view, obj):
        ...
        return (requester_institution == target_institution and 
                requester_department == target_department)